...
var import_dotenv, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_REGION, SANITY_SECRET_TOKEN, SANITY_API_VERSION, SANITY_PROJECT_ID, SANITY_DATASET;
var init_env = __esm({
  "app/src/lib/config/env.ts"() {
    "use strict";
...
var import_index, BasePatch, BaseTransaction, ClientError, ObservablePatch, ObservableSanityClient, ObservableTransaction, Patch, SanityClient, ServerError, Transaction, unstable__adapter, unstable__environment, createClient, requester, index_cjs_default;
var init_index_cjs = __esm({
  "node_modules/@sanity/client/dist/index.cjs.js"() {
    "use strict";
    import_index = __toESM(require_dist2(), 1);
    BasePatch = import_index.default.BasePatch;
    BaseTransaction = import_index.default.BaseTransaction;
    ClientError = import_index.default.ClientError;
    ObservablePatch = import_index.default.ObservablePatch;
    ObservableSanityClient = import_index.default.ObservableSanityClient;
    ObservableTransaction = import_index.default.ObservableTransaction;
    Patch = import_index.default.Patch;
    SanityClient = import_index.default.SanityClient;
    ServerError = import_index.default.ServerError;
    Transaction = import_index.default.Transaction;
    unstable__adapter = import_index.default.unstable__adapter;
    unstable__environment = import_index.default.unstable__environment;
    createClient = import_index.default.createClient;
    requester = import_index.default.requester;
    index_cjs_default = import_index.default.default;
  }
});
...
// app/src/controllers/tts.ts
var import_aws_sdk, MAX_TEXT_LENGTH, PostTTS;
var init_tts = __esm({
  "app/src/controllers/tts.ts"() {
    "use strict";
    ...
    init_sanity();
    MAX_TEXT_LENGTH = 3e3;
    PostTTS = /* @__PURE__ */ __name((request, response) => __async(void 0, null, function* () {
      try {
        ...
        const polly = new import_aws_sdk.default.Polly({
        ...
        for (const chunk of textChunks) {
          ...
          const result = yield polly.synthesizeSpeech(params).promise();
          audioStreams.push(result == null ? void 0 : result.AudioStream);
        }
        const combinedAudioStream = Buffer.concat(audioStreams);
        const sanityAudioURL = yield Client.assets.upload("file", combinedAudioStream, {
          filename: `audio/mpeg`
        });
...
// app/src/routes/tts.ts
var require_tts = __commonJS({
  "app/src/routes/tts.ts"(exports, module2) {
    "use strict";
...
// app/src/lib/config/multer.ts
var import_multer, storageEngine, upload;
var init_multer = __esm({
  "app/src/lib/config/multer.ts"() {
    "use strict";
    import_multer = __toESM(require("multer"));
    storageEngine = import_multer.default.memoryStorage();
...
// app/src/controllers/file.ts
var PostFile;
var init_file = __esm({
  "app/src/controllers/file.ts"() {
    "use strict";
    init_sanity();
    PostFile = /* @__PURE__ */ __name((request, response) => __async(void 0, null, function* () {
      try {
        if (!request.file) {
          ...
          const postToSanity = yield Client.assets.upload("file", fileBuffer, {
...
// app/src/routes/file.ts
var require_file = __commonJS({
  "app/src/routes/file.ts"(exports, module2) {
    "use strict";
    var import_express2 = __toESM(require("express"));
    init_multer();
    init_file();
...
var init_files = __esm({
  "app/src/controllers/files.ts"() {
    "use strict";
    init_sanity();
    PostFiles = /* @__PURE__ */ __name((request, response) => __async(void 0, null, function* () {
      try {
...
// app/src/routes/files.ts
var require_files = __commonJS({
  "app/src/routes/files.ts"(exports, module2) {
    "use strict";
    var import_express2 = __toESM(require("express"));
    init_multer();
    init_files();
...
var import_tts = __toESM(require_tts());
var import_file = __toESM(require_file());
var import_files = __toESM(require_files());
...
server.use((0, import_helmet.default)());
server.use(import_express.default.json());
server.use(import_express.default.urlencoded({
  extended: true
}));
server.use(import_express.default.static(import_path.default.join(__dirname, "public")));
console.log("Dir: ", import_express.default.static(import_path.default.join(__dirname, "public")));
...
server.use("/api/v1/files", import_files.default);
server.use("/api/v1/file", import_file.default);
server.use("/api/v1/tts", import_tts.default);
